...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-28 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Ready to explore the world? </h1>
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Sign in to unlock hidden gems, epic adventures, and the best travel deals—all in one place!"</p>
            <a href="" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">About Us
            ...
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <form class="mt-8 space-y-6" onSubmit={handleSubmit} action="#">
                    ...
                    <div class="text-sm font-medium text-gray-900 dark:text-white">
                        Not registered yet? 
                        <Link to={"/signup"} class="text-blue-600 hover:underline dark:text-blue-500">Create account</Link>
                    </div>
                </form>
            </div>
        </div>
